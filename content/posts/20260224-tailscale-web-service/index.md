...
{{< details summary="外部公開なしに証明書を取得できる理由" >}}
...
- Scheme: 基本的には `http`
- Forward Hostname: WEB サービスが動いているコンテナ名
...
- User DNS Challenge: ON
  ...
  - Credentials File Content: `dns_cloudflare_api_token=` 以降を先ほど取得した API トークンに書き換え (画面に映っているのはダミーの値)
